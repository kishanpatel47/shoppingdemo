      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
          ...
          {this.state.items.length <=0 ?
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
              <Icon name="heart" type="AntDesign" size={38} style={{fontSize: 38, color: '#95a5a6', marginBottom: 7}} />
        ...
        >
          ...
          <Right>
            <Button style={{marginLeft: -25}} transparent onPress={() => this.removeItemPressed(item)}>
              <Icon size={30} style={{fontSize: 30, color: '#95a5a6'}} name='minuscircleo' type="AntDesign" />
            </Button>
          </Right>
        </ListItem>
      );
