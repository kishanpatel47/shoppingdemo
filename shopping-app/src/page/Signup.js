      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
        ...
        <ScrollView contentContainerStyle={{flexGrow: 1}}>
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', paddingLeft: 50, paddingRight: 50}}>
            ...
            <Item>
                <Icon active name='mail' type="AntDesign" style={{color: '#687373'}} />
            ...
            <Item>
                <Icon active name='user' type="AntDesign" style={{color: '#687373'}} />
            ...
            <Item>
                <Icon active name='lock' type="AntDesign" style={{color: '#687373'}} />
