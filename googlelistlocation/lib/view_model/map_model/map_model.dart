...
import 'package:googlelistlocation/models/geopoint.dart';

// import 'package:flutter_tutorials/models/geopoint.dart';
import 'package:googlelistlocation/models/nearby.dart';
import 'package:googlelistlocation/models/user.dart';
import 'package:googlelistlocation/services/map_api.dart';
import 'package:googlelistlocation/services/nearby_location_api.dart';
import 'package:googlelistlocation/services/user_api.dart';
...
class MapModel extends ChangeNotifier {
  ...
  Future<void> addAllUserMakerToMap() async {
    ...
    allUser.forEach((user) async {
      await _addMarkerToMap(
        markerPosition: GeoPoint(double.parse(user.address.geo.lat),
  ...
  Future<void> getUserPosition(User user) async {
    ...
    GeoPoint point = GeoPoint(
        double.parse(user.address.geo.lat), double.parse(user.address.geo.lng));
